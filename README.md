...
To deploy *cutter* using a pre-built `Dockerfile`, it's possible to use [cutter-docker](https://github.com/ps1337/cutter-docker). The repository also contains instructions on how to get started using the docker image with minimal effort.
