    ...
    static const QHash<QString, Shortcut> defaultShortcuts = {
        ...
        { "General.focusConsole",
          { { Qt::Key_Period },
            ...
            "MainWindow" } },
        { "General.gotoEntry",
          { { Qt::Key_G }, QT_TRANSLATE_NOOP("MainWindow", "Go to Entry"), "MainWindow" } },
        { "General.seek",
        ...
        { "Decompiler.copyReferenceAddress",
          { { Qt::KeyboardModifier::ControlModifier | Qt::KeyboardModifier::ShiftModifier
            ...
            "DecompilerContextMenu" } },
        { "Decompiler.addComment",
          { { Qt::Key_Semicolon },
            QT_TRANSLATE_NOOP("DecompilerContextMenu", "Add Comment"),
            "DecompilerContextMenu" } },
        { "Decompiler.showXRefs",
          { { Qt::Key_X },
            QT_TRANSLATE_NOOP("DecompilerContextMenu", "Show X-Refs"),
            "DecompilerContextMenu" } },
        ...
        { "Disassembly.copyInstructionBytes",
          { { Qt::CTRL | Qt::ALT | Qt::Key_C },
            ...
            "DisassemblyContextMenu" } },
        { "Disassembly.addComment",
          { { Qt::Key_Semicolon },
            QT_TRANSLATE_NOOP("DisassemblyContextMenu", "Add Comment"),
            "DisassemblyContextMenu" } },
        ...
        { "Disassembly.defineFunction",
          { { Qt::Key_P },
            ...
            "DisassemblyContextMenu" } },
        { "Disassembly.showXRefs",
          { { Qt::Key_X },
            QT_TRANSLATE_NOOP("DisassemblyContextMenu", "Show X-Refs"),
            "DisassemblyContextMenu" } },
        { "Disassembly.XRefsForVariables",
          { { QKeySequence(Qt::SHIFT | Qt::Key_X) },
            ...
            "DisassemblyContextMenu" } },
        { "Disassembly.showOptions",
          { { Qt::Key_D },
            QT_TRANSLATE_NOOP("DisassemblyContextMenu", "Show Options"),
            "DisassemblyContextMenu" } },
        { "Disassembly.rename",
          { { Qt::Key_N },
        ...
        { "Disassembly.setAsStringAdvanced",
          { { Qt::SHIFT | Qt::Key_A },
            ...
            "DisassemblyContextMenu" } },
        { "Disassembly.setToDataEx", { { Qt::Key_Asterisk }, "...", "DisassemblyContextMenu" } },
        ...
        { "Disassembly.toggleBreakpoint",
          { { Qt::Key_F2, Qt::CTRL | Qt::Key_B },
            QT_TRANSLATE_NOOP("DisassemblyContextMenu", "Add/remove breakpoint"),
            "DisassemblyContextMenu" } },
        { "Disassembly.advancedBreakpoint",
          { { Qt::CTRL | Qt::Key_F2 },
            QT_TRANSLATE_NOOP("DisassemblyContextMenu", "Advanced breakpoint"),
            "DisassemblyContextMenu" } },
        { "Disassembly.switchToGraph",
          { { Qt::Key_Space },
            QT_TRANSLATE_NOOP("DisassemblyWidget", "Switch to Graph"),
            "DisassemblyWidget" } },
        { "Disassembly.seekPrev",
          { { Qt::Key_Escape },
            QT_TRANSLATE_NOOP("DisassemblyWidget", "Seek to Previous Address"),
            "DisassemblyWidget" } },
        { "Disassembly.moveDownJ",
          { { Qt::Key_J },
            QT_TRANSLATE_NOOP("DisassemblyWidget", "Move Cursor Down"),
            "DisassemblyWidget" } },
        ...
        { "Disassembly.moveUpK",
          { { Qt::Key_K },
            QT_TRANSLATE_NOOP("DisassemblyWidget", "Move Cursor Up"),
            "DisassemblyWidget" } },
        { "Disassembly.moveUp",
        ...
        { "Graph.seekPrev",
          { { Qt::Key_Escape },
            QT_TRANSLATE_NOOP("DisassemblerGraphView", "Seek to Previous Address"),
