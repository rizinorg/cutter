#ifndef DISASSEMBLER2GRAPHVIEW_H
#define DISASSEMBLER2GRAPHVIEW_H
...
class Disassembler2GraphView : public GraphView
{
    Q_OBJECT
...
public:
    Disassembler2GraphView(QWidget *parent);
...
#endif // DISASSEMBLER2GRAPHVIEW_H
