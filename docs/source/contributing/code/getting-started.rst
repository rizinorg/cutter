...
The following section in our documentation is *not* intended to be comprehensive but rather a quick guide to walk you through the basic flow of contributing to Cutter. For more thorough documentation, follow the links in this page and read our Development Guidelines.
...
The issues and the feature-requests of Cutter are listed and tracked on our `Github Issues <https://github.com/radareorg/cutter/issues>`_ page. Don't get scared by the amount of issues open, we will learn how to filter them to find those which fit you best.
...
Projects
^^^^^^^^^^
We use `projects boards <https://github.com/radareorg/cutter/projects>`_ to gather together tasks and issues for specific feature or problem. For example, we have dedicated projects boards for Debugger, Hexdump widget, Decompiler widget, and High DPI support. If you are interested to take part in developing a major feature, or you want to get a broader look of a progress of a specific part in Cutter, this can be a good place to visit.
...
When you are done, and the additions and modifications to the code are in place, commit your changes and gey your code reviewed by opening a new Pull Request. Please remember to follow the Pull Request template.
...
.. important::
    We're always in the process of improving information on this page for newcomers to the Cutter. Please help us by suggesting improvements and tell us about information that this page lacks of.
